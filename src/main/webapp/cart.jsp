	...
	<div class="container">
		...
		<c:if test="${empty requestScope.list}">
			<center>
				...
				<br>
				<a href="http://localhost:8080/dien_thoai3/home" class="button">Mua
					sắm ngay</a>
			</center>
		...
		<c:if test="${not empty requestScope.list}">
			...
			<c:forEach items="${requestScope.list}" var="c">
				<div class="product">
					...
					<div class="quantity">
						<form action="http://localhost:8080/dien_thoai3/editcart"
							method="post">
			...
			<div class="action-buttons">
				<a href="http://localhost:8080/dien_thoai3/home" class="button">Tiếp
					tục mua sắm</a>
				<c:if test="${not empty user }">
					<a class="button"
						href="http://localhost:8080/dien_thoai3/checkout?uid=${user.id }">Thanh
						toán</a>
				</c:if>
			</div>
		</c:if>
